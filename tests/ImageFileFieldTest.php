...
class ImageFileFieldTest extends TestCase
{
     ...
     */
    public function testSetUploadedFile($filename, $isRequired, $expectedImageType, $expectedImageWidth, $expectedImageHeight, $expectedIsInvalid, $expectedHasError, $expectedError)
    {
    ...
    public function setUploadedFileDataProvider()
    {
        return [
            ...
            ['jpegfile.jpg', true, ImageType::JPEG, 20, 30, false, false, null],
        ];
    }
}
